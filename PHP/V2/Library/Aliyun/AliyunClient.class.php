...
class AliyunClient
{
     ...
     * @var string
     */
    protected static $accessKeyId = 'LTAIoeaGLYBHzpDi';

    /**
     * 密钥
     * @var string
     */
    protected static $accessKeySecret = 'P8nAy2vQNMBQxElYYNedLswVIytgI7';

    /**
     * DNS API的服务接入地址
     * @var string
     */
    protected static $dnsURI = 'http://alidns.aliyuncs.com';
...
//        Log:info($params);
    ...
    public static function http_gets($baseURL, $keysArr){
        ...
        Log::info("AliyunDns#revice content:" . $sContent);
        $aStatus = curl_getinfo($ch);
        Log::info("AliyunDns#revice status:" . json_encode($aStatus));
        curl_close($ch);
        return $sContent;
    }
